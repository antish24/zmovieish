...
const Card=({id,poster_path,original_title,release_date,first_air_date,original_name,media_type,vote_average})=>{
    ...
    return(
        <div className={styles.box}>
            <div className={styles.playbox}>
                <Link onClick={()=>{return (window.scrollTo(0,0))}} to={`/zmovie/${id}`}  className={styles.play}>
